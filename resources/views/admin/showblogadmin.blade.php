...
@section('title', 'Blog and Follower')

@section('content')
 <hr class="noscreen" />
  <h1 id="title">Visualizza blog</h1>
  ...
  <div class="content box">
    ...
    <dl>
                  ...
                  | <a href="{{route('create.post.admin', $b->blogId)}}">aggiungi post</a>
            ...
            <h2>Foolower</h2>
             @foreach ($follower as $s)
                    <dl>
                        ...
                        <dd>username: <strong>{{ $s->follower }}</strong> | id: <strong>{{ $s->followerId }}</strong> </dd>
                     </dl>
                @endforeach
                @include('pagination.paginator', ['paginator' => $follower])
    ...
    <h2>Posts</h2>
        ...
        <dl>  
                ...
                <a>
                    ...
                    <p class="nomb"> 
                    <a href = "{{route('show.post.admin', $p->postId)}}">visualizza</a> | 
